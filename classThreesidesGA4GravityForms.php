...
class ThreesidesGA4GavityFormsAddOn extends GFAddOn
{

    protected $_version = Threesides_GA4_GavityForms_Version;
    ...
    public function pre_init()
    {
        ...
        if ($this->is_gravityforms_supported() && class_exists('GF_Field')) {
            require_once('classThreesidesGA4TrackingField.php');
        }
    }
