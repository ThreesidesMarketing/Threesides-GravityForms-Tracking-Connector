...
addEventListener("DOMContentLoaded", function () {
  ...
  const gclid_field = document.querySelectorAll(".gclid input[type=text]");
...
addEventListener("DOMContentLoaded", function () {
  ...
  const fbclid_field = document.querySelectorAll(".fbclid input[type=text]");
...
addEventListener("DOMContentLoaded", function () {
  ...
  const utm_field = document.querySelectorAll(".utm input[type=text]");
